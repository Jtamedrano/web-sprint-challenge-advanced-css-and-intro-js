...
1. How would you describe acessibility on the web to someone new to programming?
   > I would describe acessibility on the web as a programmers way of showing empathy to others. Some don't have accss to fast internet and can only download a small set of a websites data, so things like pictures may not show. Someone who is blind may require a webpage be read to them instead.
